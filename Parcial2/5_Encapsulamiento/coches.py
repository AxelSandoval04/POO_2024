...
class Coches:
    ...
    def __init__(self,color,marca):
       self.color=color
       self.marca=marca
    #En python el encapsulamiento tambien se llama visibilidad y por lo tanto define coomo seran los metodos es decir publicos o privados

    #Atributo publico
    publico_atributo="Soy Publico"
    #Atributo privado
    __publico__privado="Soy privado"
    ...
    def getInfo(self):
        print(f"Marca: {self.getMarca()} {self.getColor()}, numeros de plazas: {self.getPlazas()} \nModelo: {self.getModelo()} 
              con una velocidad de {self.getVelocidad()} Km/h y un potencia de {self.getCaballaje()} hp")     
#Fin definir clase
